            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-md md:text-lg font-medium text-gray-800 dark:text-white break-words">{user?.email || "No email"}</p>
            ...
            <div className="mb-8">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input 
                  ...
                  className="w-4 h-4 text-cyan-900 rounded focus:ring-cyan-500"
                />
